            ...
            <section class="container">
                ...
                <div class="box">
                    ...
                    <form action ="reservations.php" method="post">
                        ...
                        <label for="arrival">Numéro de réservation :</label>
                        <div><input class="userinput" type="text" name="arrival"></div>
                        ...
                        <div><input class="userinput" type="text" name="departure"></div>
                        ...
                        <input type="submit" name="search" value="Rechercher" class="submitbtn">
