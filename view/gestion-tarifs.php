        ...
        <main>
            ...
            <section class="container">
                ...
                <form action ="gestion-tarifs.php" method="post">
                    ...
                    <?php if (isset($err_password_1)) { echo $err_password_1 ;} ?>
                ...
                <form action ="gestion-tarifs.php" method="post">
                    ...
                    <?php if (isset($err_password_2)) { echo $err_password_2 ;} ?>
                ...
                <form action ="gestion-tarifs.php" method="post">
                    ...
                    <?php if (isset($err_password_3)) { echo $err_password_3 ;} ?>
                    <input type="password" name="password" placeholder="Confirmez avec votre mot de passe administrateur">
                ...
                <form action ="gestion-tarifs.php" method="post">
                    ...
                    <?php if (isset($err_password_4)) { echo $err_password_4 ;} ?> 
                    <input type="password" name="password" placeholder="Confirmez avec votre mot de passe administrateur">
